...
Sincrónico para decidir, evento para avisar. Si el Motor necesita la respuesta para seguir (¿puede abrir?, ¿aprobó?), llama por el gateway y espera. Si solo cuenta algo que ya pasó (intento cerrado), publica y sigue. Nadie lo bloquea.
...
Núcleo de intentos. Abre, entrega, cierra y vence intentos. Controla el cronómetro, congela la versión del desafío al abrir y marca puntualidad con las fechas que trae el contexto de Roadmap.
...
| Roadmap/Cursos | REST vía gateway | Elegibilidad antes de abrir (desbloqueo, vidas) y contexto a replicar |
| Teórico/Práctico | REST vía gateway | Entrega con versión del desafío a la ida, corrección a la vuelta |
...
- La asignación no se guarda acá, solo se replica su contexto. Evita drifts cuando Roadmap edita el roadmap. `adr/0001-no-asignacion-storage.md`
