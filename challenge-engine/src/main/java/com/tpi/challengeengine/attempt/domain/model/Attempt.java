package com.tpi.challengeengine.attempt.domain.model;

import com.tpi.challengeengine.attempt.domain.enums.AttemptStatus;

import java.time.LocalDateTime;
import java.util.UUID;

/**
 * Representa un intento realizado por un alumno sobre una version especifica
 * de un desafio.
 *
